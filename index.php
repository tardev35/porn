...
if ($vk_query->have_posts()) {
	...
	<div class="hero">
		<div class="container" tabindex="-1">
			<div class="hero-text">
				<p style="font-size:16px;font-color:#fff;">คลิปหลุดหีไทย ล้วน ๆ ดูคลิปหลุดมาใหม่เด็ด ๆ คลิปหลุดทางบ้าน ไทย18+ หีไทยสด ๆ ส่งตรงจากเอ็มไลฟ์และโอนลี่แฟน VK แอบตั้งกล้องถ่ายกับแบบสุดเสียว คลิปหลุดล่าสุด มาใหม่ก็มีให้เลือกดูกันแบบไม่ซ้ำหน้า AV ทางบ้านจากจีนสวยเด็ดก็มีให้ดู อัพเดทใหม่ล่าสุด ไม่เซ็นเซอร์​ หลุด มาใหม่ คลิปหลุดเด็ดๆ ทั่วทุกรูปแบบ ไม่ซ้ำ หีใหญ่ หีสวย หีน้องนักเรียนนักศึกษา เช่น หีน้องกวาง  หีน้องกัส หีน้องคะแนน หีน้องคุกกี้ หีน้องจอย หีน้องตูน หีน้องปลาทอง หีน้องพลอย หีน้องมาย หีน้องอะตอม หีน้องฮาย หีน้องไข่เน่า หีใหญ่ ๆ เต็มไปหมด ต่างหีเนียนกริบ สาวสวยหมวยเอ็กซ์ ขาวหุ่นเด็ด น่าเอา เว็บดูหีไทยต้องที่ เสยหี.com เท่านั้น</p>
				<p><?php 
